import m1 from "./machines/machine1.jpg";
import "./Machine.css";
const Machine = () => {
  return (
    <section>
            ...
            <div className="card">
              <div className="image-content">
                <div className="card-image">
                  <img src={m1} alt="" className="card-img" />
                </div>
              </div>
              <div className="card-content">
                <h2 className="name">Machine 1</h2>
                <h2 className="name">Category:idus</h2>
                <h2 className="name">Active</h2>
                <h2 className="name">Reference: 1500</h2>
              </div>
              <div>
                <button
                  type="button"
                  className="btn btn-outline-primary machine-cad-button"
                >
                  <svg
                ...
                <button
                  type="button"
                  className="btn btn-outline-danger machine-cad-button"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="16"
